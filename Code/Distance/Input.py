...
def find_columns(file):
    ...
    return [start_lat,start_long,dest_lat,dest_long,dist,forecast],header
...
#Performs same function as read_lines but instead of accessing file the user provides the line 
...
if __name__ == '__main__':
    ...
    #filename = sys.argv[1]
    main_path = r"C:\Users\Carson\OneDrive\College CSU\Year 4\Summer 2018"
    filename = r"\IHT Project\Data\LocationsThatNeedDistances.csv"
