...
def parse_header(header):
    crew_index = -1
    for index in range(len(header)):
        if r"CrewsToSend" in header[index] :
            crew_index = index
    if crew_index == -1:
...
if __name__ == '__main__':
    ...
    requests = r"C:\Users\Carson\OneDrive\College CSU\Year 4\Summer 2018\IHT Project\Data\Optimize Data\Reduced_Calculated.csv"
    output  = r"C:\Users\Carson\OneDrive\College CSU\Year 4\Summer 2018\IHT Project\Data\Optimize Data\opt_out.csv"
