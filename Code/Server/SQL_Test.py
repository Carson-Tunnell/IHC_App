...
if __name__ == '__main__':
    ...
    path = mainPath + r"\IHT Project\Data\Server\Daily Test\8am"
    update_path = path + r"\Report View of CREW REQUEST AUTOMATED QUERY - ONCE DAILY 0800.csv"
    crew_path   = path + r"\Report View of CREW STATUS TABLE - ONCE DAILY 0800.csv"
    conn = connect("root","Code","localhost","iht_test")
    

    update_path = r"C:\Users\Carson\OneDrive\College CSU\Year 4\Summer 2018\IHT Project\Code\Server\Report View of CREW REQUEST AUTOMATED QUERY - ONCE DAILY 0800.csv"
